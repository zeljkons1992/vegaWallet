...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff837342),
      ...
      secondaryFixedDim: Color(0xff74544c),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff837342),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(0xff8f4b38),
      primaryFixed: Color(0xffffdbd1),
      onPrimaryFixed: Color(0xff3a0b01),
      primaryFixedDim: Color(0xffffb5a0),
      onPrimaryFixedVariant: Color(0xff723523),
      ...
      secondaryFixedDim: Color(0xffe7bdb2),
      onSecondaryFixedVariant: Color(0xff5d4037),
      tertiaryFixed: Color(0xffc35535),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xffd9c58d),
      onTertiaryFixedVariant: Color(0xff534619),
      surfaceDim: Color(0xff1a110f),
      surfaceBright: Color(0xffeaef2c),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffcb7c66),
      ...
      tertiaryContainer: Color(0xffa1905c),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryFixed: Color(0xfffae6aa),
