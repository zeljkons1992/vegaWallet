...
@LazySingleton()
class RemoveStoreFromFavoritesUseCase extends UseCase<DataState, Store>{
  final StoreRepository repository;

  RemoveStoreFromFavoritesUseCase(this.repository);

  @override
  Future<DataState> call({Store? params}) async {
    return await repository.removeStoreFromFavorites(params!);
  }
}
